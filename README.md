...
|5|[First Unique Character in a string](https://leetcode.com/problems/first-unique-character-in-a-string/)|[Solution](solutions_python/first_unique_character_in_string.py)| |
